<div>
<div ng-show="comptrips.length==0" style="margin-left:2%;margin-right:2%;">
<h4>No Details Found.Please Try Again Later.</h4>
</div> 
<div style="margin-left:2%;margin-right:2%;background-color:Ivory;" ng-show="comptrips.length>0">         
  <table class="table table-bordered">
    ...
    <tbody class="text-center">
      <tr data-ng-repeat="m in comptrips">
        <td>{{m.startpoint}}</td>
        <td>{{m.endpoint}}</td>
        <td>{{m.depdate}}</td>
        <td>{{m.deptime}}</td>
